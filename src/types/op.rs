...
mod tests {
    ...
    fn user_op_eip712_digest() {
        ...
        assert_eq!(
            ...
            b256!("0xda85116cfe012991f9c8ad7e1bde99ab1c5a62c9af68322ec5675874204cf64c")
        );
        ...
        assert_eq!(
            ...
            b256!("0x02c055a48a1e4fb6518dcaea0f160c57d19c2d24c168ed2a071ef6f6101b234a")
        );
    }
    ...
    async fn user_op_with_signature() {
        ...
        let expected_digest =
            b256!("0x436cb71439e40a99a4189ce6bda025dd7f782d34fb7f4534138ec095a5e88b7f");
        assert_eq!(
            user_op.as_eip712().unwrap().eip712_signing_hash(&Eip712Domain::new(
                Some("EntryPoint".into()),
                Some("0.0.1".into()),
        ...
        assert_eq!(
            user_op.signature,
            bytes!(
                "0x9ded383334af846586ce071ff1d04bae5b8d8e9b8f1d449263b756c789a1abe025a36b91cecd423d25231e4c78e4a7d5799fbad9929841f6d9f608b7fd1350de1c"
            )
        );
        ...
        assert_eq!(
            ...
            bytes!(
                ""
            )
        );
    }
}
